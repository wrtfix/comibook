 ...
 */
$config['github_user'] = 'wrtfix';

/**
 * The repo on GitHub we will be updating from
 */
$config['github_repo'] = 'https://github.com/wrtfix/comibook';

/**
 * The branch to update from
 */
$config['github_branch'] = 'restServer';
 ...
 */
$config['current_commit'] = 'a5b6cf9b98e7ed9b9cb4f26eeb2e9a1c401e3b56';
