...
$(document).ready(function(){
	$('#agregar').click(function(){
		...
		if (agrego=='false'){ 
			$('#tablaGastos').append("<tr><td></td><td><input name='fecha' id='fecha' type='input' value=''></td><td><input name='nombre' type='input' value=''></td><td><input name='importe' type='input' value=''></td></tr>");
...
<div class="checkbox">
  ...
  <th class="header">Nombre<i class=""></i></th>
                ...
                <tr>
                  ...
                  <td><input class="formulario" id="fecha-<?php print_r($item->idGasto);?>" style='width: 100%; border:none;' type='text' value='<?php list($dia, $mes, $ano) = explode("-", $item->fecha); echo $ano."-".$mes."-".$dia;?>'/></td>
